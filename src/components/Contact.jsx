...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Matias Basilotta",
          from_email: form.email,
          to_email: "matiasbasilotta@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Gracias. Me contactare contigo muy pronto.");
        ...
        (error) => {
          ...
          alert("Ahh, algo salio mal, Por favor intentalo nuevamente.");
        }
      );
  };
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Dame un toque</p>
